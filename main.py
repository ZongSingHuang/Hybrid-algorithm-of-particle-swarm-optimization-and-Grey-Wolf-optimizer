...
for t in range(run_times):
    ...
    optimizer = HPSOGWO(fitness=benchmark.Sphere,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Rastrigin,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Ackley,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Griewank,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Rosenbrock,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Quartic,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Penalized1,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Penalized2,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Schwefel_226,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Step,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Kowalik,
    ...
    optimizer = HPSOGWO(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = HPSOGWO(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = HPSOGWO(fitness=Shekel5,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Branin,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = HPSOGWO(fitness=Shekel7,
                        D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = HPSOGWO(fitness=benchmark.Shekel,
                        D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = HPSOGWO(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Hartmann6,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Zakharov,
    ...
    optimizer = HPSOGWO(fitness=benchmark.SumSquares,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Alpine,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Michalewicz,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Exponential,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Schaffer,
    ...
    optimizer = HPSOGWO(fitness=benchmark.BentCigar,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Elliptic,
    ...
    optimizer = HPSOGWO(fitness=benchmark.DropWave,
    ...
    optimizer = HPSOGWO(fitness=benchmark.CosineMixture,
    ...
    optimizer = HPSOGWO(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = HPSOGWO(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(HPSOGWO).csv')
...
table.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                 ...
                 'Bohachevsky 1', 'Elliptic', 'Drop Wave', 'Cosine Mixture', 'Ellipsoidal',
                 'Levy and Montalvo 1']
table.to_csv('table(HPSOGWO).csv')